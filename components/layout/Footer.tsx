      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">Rentify</h3>
            <p className="text-white/80 mb-6 max-w-md">
              The smart way to access premium software. Connect with account owners and rent the tools you need at affordable prices.
            </p>
        ...
        <div className="border-t border-white/20 mt-8 pt-8 text-center">
          <p className="text-white/60">
            © 2024 Rentify. All rights reserved. Making premium software accessible to everyone.
          </p>
        </div>
      </div>
    </footer>
