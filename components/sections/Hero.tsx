...
export const Hero: React.FC = () => {
  return (
    <section className="pt-24 pb-20 bg-gradient-to-br from-primary via-secondary to-primary relative overflow-hidden bg-pattern">
      ...
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-accent-light/10 rounded-full blur-3xl floating-animation" style={{ animationDelay: '2s' }}></div>
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-accent-bright/5 rounded-full blur-3xl"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="inline-flex items-center px-6 py-3 modern-card mb-8 slide-in-up">
            ...
            <span className="text-sm font-semibold text-gray-200">100+ Premium Tools Available</span>
          ...
          <h1 className="text-5xl md:text-7xl font-black text-gray-100 mb-8 leading-tight fade-in">
            ...
            <br />
            <span className="gradient-text bg-gradient-to-r from-accent via-accent-light to-accent-bright bg-clip-text text-transparent">Starting ₹29/Hour</span>
          </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16 max-w-4xl mx-auto slide-in-up">
            <div className="text-center modern-card p-8 group">
              ...
              <div className="text-sm font-medium text-gray-300">Premium Tools</div>
            ...
            <div className="text-center modern-card p-8 group">
              ...
              <div className="text-sm font-medium text-gray-300">Starting Price</div>
              <div className="w-8 h-1 bg-accent/30 rounded-full mx-auto mt-3 group-hover:bg-accent transition-colors"></div>
            </div>
            <div className="text-center modern-card p-8 group">
            ...
            <div className="text-center modern-card p-8 group">
              ...
              <div className="text-sm font-medium text-gray-300">Happy Users</div>
              <div className="w-8 h-1 bg-accent/30 rounded-full mx-auto mt-3 group-hover:bg-accent transition-colors"></div>
            </div>
          </div>
          ...
          <div className="text-center fade-in">
            <div className="inline-flex items-center gap-2 mb-8">
              <span className="text-lg font-bold text-gray-200">Popular Tools Available Now</span>
              <span className="px-3 py-1 bg-green-600 text-green-100 rounded-full text-xs font-bold">TRENDING</span>
            </div>
            <div className="grid grid-cols-3 md:grid-cols-6 gap-4 max-w-5xl mx-auto">
              {[
                ...
                <div key={index} className="modern-card p-5 text-center group cursor-pointer" style={{ animationDelay: `${index * 0.1}s` }}>
                  <div className="w-14 h-14 mx-auto mb-3 flex items-center justify-center bg-gradient-to-br from-accent/10 to-gray-600/20 rounded-2xl group-hover:scale-110 transition-transform">
                    <img
                      src={tool.logo}
                      alt={tool.name}
                  ...
                  <div className="text-xs font-bold text-gray-200 mb-1 group-hover:text-accent transition-colors">{tool.name}</div>
